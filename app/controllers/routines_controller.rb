class RoutinesController < ApplicationController
  ...
  # GET /routines.json
  def index
    @routines = Routine.includes(:polyclinic, :post, :schedule).load.where(polyclinic_id: params[:polyclinic_id], post_id: params[:post_id], schedule_id: params[:schedule_id])
  end
  ...
  private
    ...
    def routine_params
      params.require(:routine).permit(:polyclinic_id, :post_id, :schedule_id, :timing)
    end
end
